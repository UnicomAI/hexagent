        ...
        {step === "welcome" && (
          <div className="setup-step setup-welcome">
            <div className="setup-welcome-brand">
              ...
              <h2 className="setup-welcome-title">UniHarness</h2>
            </div>
            <p className="setup-welcome-tagline">Powered by UniHarness harness</p>

            <div className="setup-welcome-form">
              <div className="setup-field">
                <label className="setup-label">What should UniHarness call you?</label>
                <input
          ...
          <div className="setup-step">
            <div className="setup-step-header">
              ...
              <div>
                ...
                <p className="setup-subtitle">
                  UniHarness uses sandboxed environments to run code safely. E2B is required for Chat mode.
                </p>
              </div>
            </div>
                  ...
                  <div className="setup-vm-phases">
                    ...
                    {vmUsable && vmPhase3 !== "done" && (
                      <p className="setup-vm-hint">
                        System dependencies install in the background — you can continue using UniHarness while it runs.
                      </p>
                    )}
                  </div>
                )}
            ...
            {showDepsPrompt && (
              <div className="setup-skip-overlay" onClick={() => setShowDepsPrompt(false)}>
                <div className="setup-skip-popup" onClick={(e) => e.stopPropagation()}>
                  ...
                  <p className="setup-deps-desc">
                    The installation runs in the background — you can start using UniHarness immediately.
                  </p>
                  <div className="setup-skip-actions">
                    <button
                      className="setup-btn setup-btn--ghost"
          ...
          <div className="setup-step">
            ...
            <div className="setup-actions setup-actions--center">
              ...
              <button
                ...
                disabled={saving}
              >
                {saving ? "Saving..." : "Start using UniHarness"}
              </button>
            </div>
          </div>
        )}
