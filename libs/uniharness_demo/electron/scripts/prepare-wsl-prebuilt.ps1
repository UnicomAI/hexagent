...
$UniharnessRoot = Resolve-Path "$ScriptDir\..\..\.."
$PrebuiltDir = Join-Path $UniharnessRoot "uniharness\sandbox\vm\wsl\prebuilt"
$PrebuiltTar = Join-Path $PrebuiltDir "uniharness-prebuilt.tar"
$DistroName = "uniharness"
