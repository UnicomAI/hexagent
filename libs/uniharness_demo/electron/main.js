...
//   macOS:   ~/Library/Application Support/UniHarness/
//   Windows: %APPDATA%/UniHarness/
//   Linux:   ~/.config/UniHarness/
...
async function spawnBackend() {
  ...
  if (IS_DEV) {
    ...
    let binaryName = "uniharness_api_server";
    ...
    backendProcess = spawn(binaryPath, [], {
      ...
      env: {
        ...
        HOST: "127.0.0.1",
        PORT: String(port),
        UNIHARNESS_DATA_DIR: userDataDir,
      },
    });
  }
