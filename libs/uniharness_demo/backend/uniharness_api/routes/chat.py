...
from uniharness.computer.base import SESSION_OUTPUTS_DIR, SESSION_UPLOADS_DIR
from uniharness.exceptions import VMMountConflictError

from uniharness_api.agent_manager import agent_manager
from uniharness_api.config import load_config
from uniharness_api.models import MessageRequest
from uniharness_api.paths import pdf_cache_dir, uploads_dir
from uniharness_api.store import store
from uniharness_api.stream_manager import stream_manager
...
SUBAGENT_TAG_PREFIX = "uniharness:subagent:"
INTERNAL_TOOL_TAG = "uniharness:tool"
...
async def _generate_events(  # noqa: C901
    ...
    :pymod:`uniharness_api.stream_manager` so it is **not** tied to any HTTP
