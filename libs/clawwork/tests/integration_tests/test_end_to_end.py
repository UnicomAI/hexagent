"""End-to-end unit tests for clawwork with fake LLM models."""
...
from clawwork.langchain import create_agent
...
class TestDeepAgentEndToEnd:
    ...
    async def test_deep_agent_with_string_model_name(self) -> None:
        ...
        with patch("clawwork.langchain.agent.init_chat_model", return_value=fake_model):
