...
from clawwork.exceptions import CLIError
from clawwork.tools import ReadTool
from clawwork.tools.cli.read import _LINE_SEPARATOR, _MAX_IMAGE_BYTES, _truncate_long_lines, read_file
from clawwork.types import Base64Source, CLIResult
...
class TestReadToolLongLines:
    ...
    async def test_long_lines_truncated(self, tool: ReadTool, long_line_file: str) -> None:
        ...
        from clawwork.tools.cli.read import _MAX_LINE_LENGTH
