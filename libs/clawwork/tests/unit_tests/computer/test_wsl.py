...
from clawwork.computer.base import BASH_MAX_TIMEOUT_MS, Computer
from clawwork.computer.local._types import ResolvedMount
from clawwork.computer.local._wsl import (
    WslVM,
    _parse_status_output,
    _session_user_from_guest_mount_path,
    _win_path_to_wsl,
)
from clawwork.computer.local.vm_win import LocalVM, _VMSessionComputer
from clawwork.exceptions import CLIError, MissingDependencyError, UnsupportedPlatformError, VMError, WslError
...
class TestWslVMInit:
    ...
    def test_rejects_non_win32(self) -> None:
        with (
            patch("clawwork.computer.local._wsl._PLATFORM", "darwin"),
    ...
    def test_rejects_missing_wsl(self) -> None:
        with (
            patch("clawwork.computer.local._wsl._PLATFORM", "win32"),
...
class TestStatusParsing:
    ...
    def test_utf8_output(self) -> None:
        ...
        assert entries[1] == {"name": "clawwork", "state": "Stopped", "version": "2"}
    ...
    def test_utf16le_with_bom(self) -> None:
        ...
        assert entries[0]["name"] == "clawwork"
    ...
    def test_multiple_distros(self) -> None:
        ...
        assert names == ["Ubuntu", "Debian", "clawwork"]
