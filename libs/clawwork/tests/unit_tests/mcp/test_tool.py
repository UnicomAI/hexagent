"""Tests for clawwork.mcp._tool — McpTool and result conversion."""
...
from clawwork.mcp._tool import McpTool, _convert_result
from clawwork.types import Base64Source
