...
**ClawWork** is a general-purpose agent harness that **gives LLM agents access to a computer via the terminal** to complete tasks the way humans do.
...
- When discussing architecture for ClawWork, maintain awareness that the project values: framework-agnostic design, clean patterns, and separation of concerns. Avoid coupling to specific LLM providers or frameworks (except integration dir, e.g. langchain/).
...
**Test Organization**:
- Unit tests: `tests/unit_tests/` — mirrors `clawwork/` structure
