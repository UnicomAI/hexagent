"""Shared data types for ClawWork.
...
class SubagentRunner(Protocol):
    ...
    :class:`~clawwork.langchain.subagent.LangChainSubagentRunner`.
    """
...
class EnvironmentContext:
    ...
    Populated by :class:`~clawwork.harness.environment.EnvironmentResolver`
...
class AgentContext:
    ...
    def tool_name_vars(self) -> dict[str, str]:
        ...
        suitable for unpacking into :func:`~clawwork.prompts.content.substitute`.
        """
