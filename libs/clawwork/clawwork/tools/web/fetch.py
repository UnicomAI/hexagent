...
from clawwork.exceptions import ConfigurationError, ToolError, WebAPIError
from clawwork.prompts.content import load, substitute
from clawwork.tools.base import BaseAgentTool
from clawwork.tools.web._cache import cache_key, get_fetch_cache
from clawwork.tools.web._validation import validate_url
from clawwork.types import ToolResult, WebFetchToolParams

if TYPE_CHECKING:
    from clawwork.tools.web.providers.fetch import FetchProvider
    from clawwork.types import CompletionModel
...
class WebFetchTool(BaseAgentTool[WebFetchToolParams]):
    ...
    Examples:
        ```python
        from clawwork.tools.web.providers.fetch import JinaFetchProvider
