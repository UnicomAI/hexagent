...
from clawwork.prompts.tags import SYSTEM_REMINDER_TAG, Tag

if TYPE_CHECKING:
    from collections.abc import Callable, Sequence

    from clawwork.tasks import TaskRegistry
    from clawwork.types import AgentContext
...
a :class:`~clawwork.tasks.TaskRegistry` instance. It is added
