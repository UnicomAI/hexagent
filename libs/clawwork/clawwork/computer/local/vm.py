...
from clawwork.exceptions import CLIError, UnsupportedPlatformError, VMError, VMMountConflictError
...
class LocalVM:
    ...
    def __init__(self, *, instance: str = "clawwork") -> None:
        ...
        if sys.platform == "darwin":
            from clawwork.computer.local._lima import LimaVM as _LimaVM
