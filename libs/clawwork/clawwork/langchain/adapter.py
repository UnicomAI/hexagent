"""Adapter for converting ClawWork tools to LangChain tools.

This module provides the bridge between ClawWork's framework-agnostic
...
def to_langchain_tool(
    ...
    *,
    ...
    Examples:
        ```python
        from clawwork.tools.cli import BashTool
        from clawwork.langchain import to_langchain_tool
