"""Agent middleware — the actual runtime for ClawWork.
...
from clawwork.harness import PermissionResult, evaluate_reminders
from clawwork.langchain.adapter import to_langchain_tool
from clawwork.prompts import compose, load, substitute
from clawwork.prompts.tags import SYSTEM_REMINDER_TAG
from clawwork.types import AgentContext, CompactionPhase
...
if TYPE_CHECKING:
    ...
    from clawwork.prompts import SectionFn
...
_IMAGE_EXTRACTED = "clawwork:images_extracted"
...
class ClawWorkState(AgentState):
...
class AgentMiddleware(LangChainAgentMiddleware):
    """The ClawWork runtime, implemented as LangChain middleware.
