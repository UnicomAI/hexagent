...
from clawwork.computer.base import SESSION_OUTPUTS_DIR, SESSION_UPLOADS_DIR
from clawwork.exceptions import VMMountConflictError

from clawwork_api.agent_manager import agent_manager
from clawwork_api.config import load_config
from clawwork_api.models import MessageRequest
from clawwork_api.paths import pdf_cache_dir, uploads_dir
from clawwork_api.store import store
from clawwork_api.stream_manager import stream_manager
...
SUBAGENT_TAG_PREFIX = "clawwork:subagent:"
INTERNAL_TOOL_TAG = "clawwork:tool"
...
async def _generate_events(  # noqa: C901
    ...
    :pymod:`clawwork_api.stream_manager` so it is **not** tied to any HTTP
