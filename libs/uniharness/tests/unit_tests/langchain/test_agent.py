...
from uniharness.langchain.agent import Agent, _resolve_to_profile, _validate_agent_tools
...
class TestResolveToProfile:
    ...
    def test_string_model_resolved(self) -> None:
        ...
        with patch("uniharness.langchain.agent.init_chat_model", return_value=mock_model) as mock_init:
