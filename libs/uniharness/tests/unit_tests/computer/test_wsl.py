...
from uniharness.computer.base import BASH_MAX_TIMEOUT_MS, Computer
from uniharness.computer.local._types import ResolvedMount
from uniharness.computer.local._wsl import WslVM, _parse_status_output, _win_path_to_wsl
from uniharness.computer.local.vm_win import _VMSessionComputer
from uniharness.exceptions import CLIError, MissingDependencyError, UnsupportedPlatformError, VMError, WslError
from uniharness.types import CLIResult
...
class TestWslVMInit:
    ...
    def test_rejects_non_win32(self) -> None:
        with (
            patch("uniharness.computer.local._wsl._PLATFORM", "darwin"),
    ...
    def test_rejects_missing_wsl(self) -> None:
        with (
            patch("uniharness.computer.local._wsl._PLATFORM", "win32"),
...
class TestStatusParsing:
    ...
    def test_utf8_output(self) -> None:
        ...
        assert entries[1] == {"name": "uniharness", "state": "Stopped", "version": "2"}
    ...
    def test_utf16le_with_bom(self) -> None:
        ...
        assert entries[0]["name"] == "uniharness"
    ...
    def test_multiple_distros(self) -> None:
        ...
        assert names == ["Ubuntu", "Debian", "uniharness"]
