"""Tests for uniharness.mcp._tool — McpTool and result conversion."""
...
from uniharness.mcp._tool import McpTool, _convert_result
from uniharness.types import Base64Source
