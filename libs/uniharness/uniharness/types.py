"""Shared data types for UniHarness.
...
class EnvironmentContext:
    ...
    Populated by :class:`~uniharness.harness.environment.EnvironmentResolver`
...
class AgentContext:
    ...
    def tool_name_vars(self) -> dict[str, str]:
        ...
        suitable for unpacking into :func:`~uniharness.prompts.content.substitute`.
        """
