"""Tool implementations for uniharness.
...
For LangChain integration, see uniharness.langchain module.
"""

from typing import Any

from uniharness.tools.base import BaseAgentTool
from uniharness.tools.cli import (
    BashTool,
    EditTool,
    GlobTool,
    GrepTool,
...
from uniharness.tools.todo import TodoWriteTool
from uniharness.tools.ui import PresentToUserTool
from uniharness.tools.web import (
    WebFetchTool,
    WebSearchTool,
    create_web_tools,
)
from uniharness.types import SubagentResult, SubagentRunner
...
UniHarness always has a computer — these tools are non-negotiable.
...
:class:`~uniharness.types.SubagentRunner` protocol. TaskOutputTool and
