...
from uniharness.tools.web._cache import cache_key, get_search_cache
from uniharness.types import ToolResult, WebSearchToolParams

if TYPE_CHECKING:
    from uniharness.tools.web.providers.search import SearchProvider
...
class WebSearchTool(BaseAgentTool[WebSearchToolParams]):
    ...
    Examples:
        ```python
        from uniharness.tools.web.providers.search import TavilySearchProvider
