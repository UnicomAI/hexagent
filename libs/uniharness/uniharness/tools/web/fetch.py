...
from uniharness.exceptions import ConfigurationError, ToolError, WebAPIError
from uniharness.prompts.content import load, substitute
from uniharness.tools.base import BaseAgentTool
from uniharness.tools.web._cache import cache_key, get_fetch_cache
from uniharness.tools.web._validation import validate_url
from uniharness.types import ToolResult, WebFetchToolParams

if TYPE_CHECKING:
    from uniharness.tools.web.providers.fetch import FetchProvider
    from uniharness.types import CompletionModel
...
class WebFetchTool(BaseAgentTool[WebFetchToolParams]):
    ...
    Examples:
        ```python
        from uniharness.tools.web.providers.fetch import JinaFetchProvider
