...
The :class:`~uniharness.types.SubagentRunner` protocol and
:class:`~uniharness.types.SubagentResult` data type live in
:mod:`uniharness.types`.
"""
...
from uniharness.types import AgentToolParams, SubagentRunner, ToolResult
