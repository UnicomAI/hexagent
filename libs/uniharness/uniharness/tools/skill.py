...
from uniharness.types import SkillToolParams, ToolResult

if TYPE_CHECKING:
    from uniharness.types import SkillCatalog


class SkillTool(BaseAgentTool[SkillToolParams]):
    """Tool for invoking skills by name.

    Delegates validation to a :class:`~uniharness.types.SkillCatalog`,
