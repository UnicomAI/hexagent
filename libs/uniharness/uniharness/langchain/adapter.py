"""Adapter for converting UniHarness tools to LangChain tools.

This module provides the bridge between UniHarness's framework-agnostic
...
def to_langchain_tool(
    ...
    *,
    ...
    Examples:
        ```python
        from uniharness.tools.cli import BashTool
        from uniharness.langchain import to_langchain_tool
