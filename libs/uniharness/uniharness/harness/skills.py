...
from uniharness.exceptions import SkillError
from uniharness.harness.skill_spec import parse_skill_md, validate_skill_dir_name
from uniharness.types import Skill

if TYPE_CHECKING:
    from uniharness.computer.base import Computer
...
class SkillResolver:
    ...
    async def has(self, name: str) -> bool:
        ...
        Satisfies the :class:`~uniharness.types.SkillCatalog` protocol.
