...
from uniharness.computer.base import ExecutionMetadata
from uniharness.computer.local._types import ResolvedMount
from uniharness.exceptions import MissingDependencyError, UnsupportedPlatformError, WslError
...
class WslVM:
    ...
    def _config_dir(self) -> Path:
        ...
        data_dir = os.environ.get("UNIHARNESS_DATA_DIR")
        base = Path(data_dir) if data_dir else Path.home() / ".uniharness"
