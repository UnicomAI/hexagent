...
from uniharness.exceptions import CLIError, UnsupportedPlatformError, VMError, VMMountConflictError

if TYPE_CHECKING:
    from uniharness.computer.local._lima import LimaVM
...
class LocalVM:
    ...
    def __init__(self, *, instance: str = "uniharness") -> None:
        ...
        if sys.platform == "darwin":
            from uniharness.computer.local._lima import LimaVM as _LimaVM
