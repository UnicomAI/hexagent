...
from uniharness.computer.base import (
    BASH_MAX_TIMEOUT_MS,
    SESSION_DIRS,
    SESSION_OUTPUTS_DIR,
    SESSION_TMP_DIR,
...
from uniharness.exceptions import CLIError, VMError, VMMountConflictError

if TYPE_CHECKING:
    from uniharness.computer.local._wsl import WslVM
...
class LocalVM:
    ...
    def __init__(self, *, instance: str = "uniharness") -> None:
        ...
        from uniharness.computer.local._wsl import WslVM as _WslVM
            ...
            if not truly_new:
                ...
                for r in resolved_new:
                    ...
                    if probe.exit_code != 0:
                        from uniharness.computer.local._wsl import _session_user_from_guest_mount_path, _win_path_to_wsl
                        ...
                        skip_chown = os.environ.get("UNIHARNESS_WSL_SKIP_SESSION_MOUNT_CHOWN", "").strip().lower() in (
                            "1",
                            "true",
                            "yes",
                        )
