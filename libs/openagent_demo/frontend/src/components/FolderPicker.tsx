        ...
        <div className="fp-permission-overlay" onClick={() => setPendingFolder(null)}>
          <div className="fp-permission-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="fp-permission-title">
              Allow OpenAgent to access files in "{pendingFolder}"?
            </h3>
            <p className="fp-permission-body">
              This grants access to all files and subfolders. OpenAgent will be able to read, edit, and delete files in this directory. File contents may be shared with connected AI models and tools. Avoid selecting folders containing sensitive or private data.
            </p>
