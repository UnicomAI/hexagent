...
from openagent.exceptions import CLIError, VMError, VMMountConflictError

if TYPE_CHECKING:
    from openagent.computer.local._wsl import WslVM
...
class LocalVM:
    ...
    def __init__(self, *, instance: str = "openagent") -> None:
        ...
        from openagent.computer.local._wsl import WslVM as _WslVM
