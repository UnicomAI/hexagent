...
The :class:`~hexagent.types.SubagentRunner` protocol and
:class:`~hexagent.types.SubagentResult` data type live in
:mod:`hexagent.types`.
"""
...
from hexagent.types import AgentToolParams, SubagentRunner, ToolResult
