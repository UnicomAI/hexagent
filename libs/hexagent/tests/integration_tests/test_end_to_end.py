"""End-to-end unit tests for hexagent with fake LLM models."""
...
from hexagent.langchain import create_agent
...
class TestDeepAgentEndToEnd:
    ...
    async def test_deep_agent_with_string_model_name(self) -> None:
        ...
        with patch("hexagent.langchain.agent.init_chat_model", return_value=fake_model):
